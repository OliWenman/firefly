...
class firefly_setup:
    ...
    """
    def __init__(self,path_to_spectrum, N_angstrom_masked=20., milky_way_reddening=True, hpf_mode = 'on'):
    ...
    def openMANGASpectrum(self, data_release, path_to_logcube, path_to_drpall, bin_number, plate_number, ifu_number):
        ...
        if data_release == 'MPL8':
            ...
            # Correct sigma for instrumental resolution
            velocity_dispersion_wrong = maps_header['STELLAR_SIGMA'].data
            velocity_dispersion_correction = maps_header['STELLAR_SIGMACORR'].data[0,:,:]     #use 1st channel of STELLAR_SIGMACORR, as in MPL7      
